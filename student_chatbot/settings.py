"""
Django settings for student_chatbot project.
...
SECRET_KEY = 'django-insecure-^&3ua0&nm$jcjb=p&jpaxl)km7i*v*p%@e#wvd_9-pzh#65ksg'
...
ROOT_URLCONF = 'student_chatbot.urls'
...
WSGI_APPLICATION = 'student_chatbot.wsgi.application'
